  ...
  return (
    <Card>
      <div className="flex items-start justify-between mb-2">
        ...
        <div className="p-1.5 rounded-lg bg-emerald-100 dark:bg-emerald-900/40 flex-shrink-0">
      ...
      {prevMonthTotal > 0 ? (
        <div className="flex items-center gap-1 pt-2 border-t border-slate-200 dark:border-slate-700">
          {delta > 0 ? (
            ...
            <Minus size={11} className="text-slate-400 flex-shrink-0" />
          )}
          <span
            className={`text-xs ${
              delta > 0
          ...
          <span className="text-xs text-slate-400 dark:text-slate-500">vs last mo.</span>
        </div>
      ) : (
